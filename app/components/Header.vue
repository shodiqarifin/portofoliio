...
<template>
  <header class="sticky top-0 z-50 border-b border-slate-800 bg-slate-900/80 backdrop-blur-sm">
    <div class="max-w-7xl mx-auto flex items-center justify-between px-4 py-4 md:px-0">
      ...
      <!-- Desktop Trakteer -->
      <a href="https://trakteer.id/shodiq_arifin" target="_blank" rel="noopener noreferrer"
        class="hidden md:block transition opacity-80 hover:opacity-100">
        <img src="https://cdn.trakteer.id/images/embed/trbtn-red-1.png" alt="Trakteer" class="h-8 w-auto" />
      </a>
      ...
      <button
        ...
        <svg v-if="!isOpen" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
